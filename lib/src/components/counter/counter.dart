...
//  if server then stub else on client show real
import '../flutter/flutter_counter.dart'
    if (dart.library.io) '../flutter/stubs/flutter_counter_fallback.dart';
    ...
    css('.counter', [
      css('&').flexbox(alignItems: AlignItems.center).box(
            ...
            border: Border.symmetric(
                vertical: BorderSide.solid(color: primaryColor, width: 1.px)),
          ),
      css('button', [
        css('&')
            .text(fontSize: 2.rem)
